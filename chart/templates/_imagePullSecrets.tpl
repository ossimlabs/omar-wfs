...
*/}}
{{- define "omar-wfs.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-wfs.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-wfs.generateImagePullSecret" }}
